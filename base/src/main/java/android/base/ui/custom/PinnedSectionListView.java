...
import android.base.ui.widget.BaseListView;
...
//                                ContextCompat.getColor(getContext(), R.color.app_theme)}
    ...
    void createPinnedShadow(int position) {
        ...
        // measure & layout
        int ws = View.MeasureSpec.makeMeasureSpec(getWidth() - getListPaddingLeft()
                - getListPaddingRight(), View.MeasureSpec.EXACTLY);
